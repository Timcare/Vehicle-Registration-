...
from . forms import VehicleForm,VehicleInfoForm,OwnerInfoForm,IndividualForm,CompanyForm,VehicleProofForm
...
def dashboard(request):
    ...
    if request.method=='POST':
        ...
        vehicleproof=VehicleProofForm(request.POST,request.FILES)
        ...
        if vehicleform.is_valid() and vehicleinfo.is_valid and vehicleproof.is_valid():# and individualform.is_valid() and companyform.is_valid() :
            vehicles=vehicleform.save(commit=False)
            vehicles.user=users
            vehicles.save()
            vehiclef=vehicleinfo.save(commit=False)
            vehiclef.vehicle=vehicles
            vehiclef.save()
            vehicleproof.save()
    ...
    return render(request,'vehicleregistration.html',{'vehicleform':vehicleform,'vehicleinfo':vehicleinfo,'vehicleproof':vehicleproof})
